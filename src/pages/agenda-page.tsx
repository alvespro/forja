...
export function AgendaPage() {
  ...
  return <div className="flex flex-col gap-5">
    <header className="flex flex-wrap items-center justify-between gap-3"><div><h1 className="text-2xl font-bold">Agenda</h1><p className="text-sm text-aco-texto">Seu tempo, em um só lugar.</p></div><div className="flex flex-wrap gap-2"><Button asChild><Link to="/agenda/assistente">Agendar com IA</Link></Button><Button variant="outline" onClick={() => setSelected('new')}>Novo evento</Button></div></header>
